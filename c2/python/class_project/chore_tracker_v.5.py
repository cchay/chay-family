...
class login:
   def opening(self):
      ...
      if action == '1':
         ...
         print('''New Updates:
2016.12.29, Chore_Tracker v.5
   * Removed bug in the delete selection
   * Created a function that prevents overwriting profiles
   * Created instructions in the Login and Sign up page that tells you how to go back
   * Fixed little odds and ends here and there
         
2016.12.26-2016.12.27, Chore_Tracker v.4
   ...
   if action == 'c':
      ...
      try:
         ...
         if confirm == 'y':
            ...
            print('SYSTEM: Task not deleted')
         else:
            print('ERROR: You did not confirm properly')
